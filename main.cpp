...
public:
    ...
    void add_customer(const string& name, int id, double cash_balance, double card_balance, double crypto_balance) 
    {
        auto customer = make_shared<Customer>(name, id, cash_balance);
...
void add_customer(Marketplace& marketplace) 
{
    ...
    marketplace.add_customer(name, id, cash_balance, card_balance, crypto_balance);
}
